...
FAQ_DATA = {
    ...
    # "📋 Страховка": (
    #     "📋 <b>Страховка</b>\n\n"
    #     "• Стоимость товара <20$/кг — <b>1%</b>\n"
    #     "• Стоимость товара 20-30$/кг — <b>2%</b>\n"
    #     "• Стоимость товара 30-40$/кг — <b>3%</b>\n"
    #     "• Стоимость товара >40$/кг — <b>обсуждается отдельно</b>"
    # ),
    ...
    "ℹ️ Дополнительная информация": (
        ...
        "<b>🔸 Страховка:</b>\n"
        "Действует при потере, краже или частичной пропаже товара. Карго не возмещает стоимость за помятую упаковку.\n"
        "Запрещенные к перевозке товары: порошковые вещества, легковоспламеняющиеся материалы, жидкости, табачные\n"
        "изделия, лекарственные препараты, режущие предметы, продукты питания."
    ),
...
def get_main_reply_keyboard():
    keyboard = ReplyKeyboardMarkup(
        keyboard=[
            ...
            [
                KeyboardButton(text="📝 Отзывы")  # Новая кнопка "Отзывы"
            ]
        ],
...
def get_faq_inline_keyboard():
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        # [InlineKeyboardButton(text="📋 Страховка", callback_data="faq_packagin")],
...
def get_smart_response(message_text):
    ...
    if any(word in text for word in ['привет', 'здравствуй', 'добро пожаловать', 'hi', 'hello']):
        return "👋 Привет! Я умный помощник China Together - ваш надежный партнер для доставки из Китая! Помогу рассчитать стоимость, оформить заказ и ответить на любые вопросы. Используйте кнопки ниже для быстрого доступа к функциям!"
