...
# Создание reply-клавиатуры (главное меню) - ОБНОВЛЕНО
...
# Функция для отправки PDF с тарифами - НОВАЯ ФУНКЦИЯ
...
# Обработка reply-кнопок - ОБНОВЛЕНО
@dp.message(F.text.in_([
    "📊 Рассчитать доставку", 
    "🚚 Заказать доставку", 
    "📂 Мои заявки",
    "💬 Связаться с менеджером",
    "📋 Актуальные тарифы",  # НОВАЯ КНОПКА
    "📱 Дополнительно",
    "❓ Помощь",
    "📋 История расчетов",
    "📞 Поддержка",
...
async def handle_reply_buttons(message: types.Message):
    ...
    # НОВЫЙ ОБРАБОТЧИК ДЛЯ КНОПКИ ТАРИФОВ
...
# Обработка текстовых сообщений (кроме команд кнопок) - ОБНОВЛЕНО
@dp.message(F.text)
async def handle_text_message(message: types.Message):
    ...
    # Пропускаем обработку, если это текст кнопки - ОБНОВЛЕНО
    button_texts = [
        "📊 Рассчитать доставку", "🚚 Заказать доставку", "📂 Мои заявки",
        "💬 Связаться с менеджером", "📋 Актуальные тарифы", "📱 Дополнительно", 
        "❓ Помощь", "📋 История расчетов", "📞 Поддержка", "🔙 Главное меню"
    ]
