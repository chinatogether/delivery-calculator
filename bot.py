...
FAQ_DATA = {
    ...
    "📦 Виды упаковки": (
        ...
        "• <b>Палета</b> (деревянный поддон + водозащитная пленка + деревянный каркас + скотч): 25$/куб"
    ),
    "🛡️ Стоимость страховки": (
        "🛡️ </b>Стоимость страховки</b>\n\n"
...
def get_faq_inline_keyboard():
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🛡️ Стоимость страховки", callback_data="faq_insurance")],
...
async def handle_callback(callback: CallbackQuery):
    ...
    if callback.data == "new_calculation":
        ...
        faq_key_map = {
            ...
            "faq_insurance": "🛡️ Стоимость страховки",
