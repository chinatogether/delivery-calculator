...
class TelegramNotifier:
    ...
    def __init__(self):
        ...
        self.chat_id = os.getenv('TELEGRAM_NOTIFICATIONS_CHAT_ID')  # ID группы/канала
        self.admin_chat_ids = os.getenv('TELEGRAM_ADMIN_CHAT_IDS', '').split(',')  # ID админов
    ...
    async def send_new_order_notification(self, order_data):
        ...
        try:
            ...
            message += f"⏰ <b>Требует ответа в рабочее время</b>\n"
            message += f"📞 <b>График:</b> ПН-ПТ 10:00-18:00 МСК"
...
def send_order_notification(order_data):
    """Синхронная отправка уведомления о заявке"""
    try:
